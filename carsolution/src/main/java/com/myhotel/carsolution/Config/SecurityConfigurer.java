package com.myhotel.carsolution.Config;

import com.myhotel.carsolution.Services.MyUserDetailsService;
import com.myhotel.carsolution.Util.JwtResquestFilter;
...
public class SecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests().antMatchers("/api/v1/autheticante").permitAll()
